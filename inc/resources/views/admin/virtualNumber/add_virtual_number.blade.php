...
@section('add_virtual_number_menu_class', 'active')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-container">
                ...
                <form action="{{ route('admin.virtualNumber.store') }}" method="post" class="form-horizontal"
                      role="form">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="virtual_number" value="{{ old('virtual_number') }}"
                                   class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="virtual_number_name" value="{{ old('virtual_number_name') }}"
                                   class="form-control"
