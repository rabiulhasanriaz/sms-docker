...
@section('add_fund_debit_menu_class','current-page')
               ...
               <div class="col-sm-6 offset-sm-3">
                <form action="{{ route('reseller.balance.debit.store') }}" method="post" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<br />
						<select class="select2 form-control" id="form-field-select-3" data-placeholder="Company name.." name="user_id" required="" onchange="user_balance(this.value)">
							<option value="">  </option>
